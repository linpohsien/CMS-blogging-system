...
<div class="container">
    <div class="row">
        ...
        ?>
                    ...
                    <hr>
                    <img class="img-responsive" src="/demo/cms/images/<?php echo imagePlaceholder($post_image); ?>" alt="">
                    ...
                    ?>
                        <div class="row">
                            <p class="pull-right login-to-post">You need to <a href="/demo/cms/login.php">login</a> to like </p>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.like').click(function(){
                $.ajax ({
                    url: "/demo/cms/post.php?p_id=<?php echo $the_post_id; ?>",
                    type: 'post',
                    data: {
                        'liked': 1,
                        'post_id': post_id,
