    ...
    foreach ($_POST['checkBoxArray'] as $postValueId) {
        ...
        switch ($bulk_options) {
            ...
            case 'clone':
                ...
                $query .= "VALUES({$post_category_id},'{$post_title}', '{$user_id}', '{$post_author}','{$post_user}',now(),'{$post_image}','{$post_content}','{$post_tags}', '{$post_status}') ";
...
$query .= "FROM posts ";
$query .= "LEFT JOIN categories ON posts.post_category_id = categories.cat_id AND posts.post_user = '$user'";
